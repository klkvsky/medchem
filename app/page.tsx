...
function RequestAccess() {
  return (
    <div className="w-full h-full pt-32 relative md:py-32">
      <div className="flex flex-col items-start w-fit mx-auto justify-center gap-2 translate-x-[20%] md:absolute md:top-1/2 md:-translate-y-1/2 md:-left-2">
        <h3 className="text-display-1 uppercase font-aeonik-mono">IPLN</h3>
      ...
      <div className="w-92 h-auto aspect-square bg-dark-gray rounded-full mx-auto mt-8 relative md:w-104">
        <button
          className="text-white text-center text-xs font-light leading-[1.1] tracking-[-0.02em] uppercase absolute top-1/2 left-1/2 -translate-1/2 px-4.5 py-3 rounded-[10px] font-aeonik-mono md:text-[6px] md:font-light md:not-italic md:leading-[110%] md:tracking-[-0.12px]  md:py-1.5 md:px-2 md:rounded-[5px]"
          style={{
            background:
...
function TeamMember({
  ...
  return (
    <div className="flex flex-col items-start">
      ...
      <div className="text-subtitle-1 flex flex-col items-start gap-0 mt-2 h-10 font-diatype">
  ...
  return (
    <div className="flex flex-col pt-30">
      <div className="flex flex-row items-end px-2">
        ...
        <div className="border-y text-burgundy border-current h-fit relative py-[7px] px-[3px]">
          <div className="absolute top-1/2 -translate-y-[49%] right-[80%] h-[77%] aspect-square w-auto border-l border-t -rotate-45 border-current" />
          <div className="absolute top-1/2 -translate-y-[49%] left-[80%] h-[77%] aspect-square w-auto border-l border-t rotate-135 border-current" />
          <p className="font-aeonik-mono uppercase text-xs font-light leading-[1.1] tracking-[0.01em] ">
            Ученых
          </p>
        </div>
      </div>
      <div className="flex flex-col mt-6 pt-30 bg-light-gray gap-15 pb-20 md:mt-12 md:pt-6 md:gap-10 md:pb-6">
    ...
    >
      <div className="flex flex-col items-center justify-center md:-translate-x-1/8">
        <svg
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className="md:w-[136px] md:h-[264px]"
        >
          <path
        ...
        <Link
          href="/"
          className="text-white text-center text-xs font-light leading-[1.1] tracking-[-0.02em] uppercase font-aeonik-mono py-3 px-4.5 rounded-[10px] translate-x-20 -translate-y-10 md:text-[6px] md:font-light md:not-italic md:leading-[110%] md:tracking-[-0.12px]  md:py-1.5 md:px-2 md:rounded-[5px]"
          style={{
            background:
      ...
      <div className="flex flex-row w-full items-end justify-end text-subtitle-1 text-white mt-40 md:mt-0">
        <div className="flex flex-row items-start gap-1 w-full md:items-center">
          <div className="w-[9px] h-[9px] bg-white md:w-[6px] md:h-[6px]" />
          <p>
            Designed & Developed <br className="md:hidden" />
            by VOSK
          </p>
        </div>
        <div className="flex flex-col gap-1 w-fit whitespace-nowrap">
          <p>
            ООО «МЕД ХЕМ» 2026 <br />
            ИНН: 9731155581
          </p>
