...
export function Hero() {
  return (
    <div
      className="text-white h-dvh flex flex-col items-center justify-end gap-3 md:gap-5.5 pb-43 md:items-start"
      style={{
        background:
    ...
    >
      <h1 className="text-h1 flex flex-col uppercase">
        ...
        <span className="ml-[1ch] md:ml-[1.5ch]">будущее</span>
        <span className="ml-[1ch] md:ml-[2.8ch]">фармацевтики</span>
      </h1>
      <HeroDescription />
    </div>
  );
...
function HeroDescriptionItem({
  ...
  return (
    <div className="flex flex-row items-center gap-2 shrink-0 flex-none md:gap-3.5">
      <Image
        src={icon}
        alt={text}
        width={12}
