...
function PartnersItem({ partner }: { partner: PartnerData }) {
  ...
  return (
    <div className="flex flex-col items-center justify-start shrink-0 w-[clamp(7.5rem,calc(5.7143rem_+_8.9286vw),10rem)] md:w-[clamp(8.75rem,calc(5.625rem_+_6.5104vw),11.25rem)] xl:w-[clamp(8.75rem,10.9375vw,10.5rem)] 2xl:w-[clamp(10.5rem,10.9375vw,13.125rem)] 3xl:w-[clamp(13.125rem,10.9375vw,17.5rem)] gap-[clamp(0.75rem,calc(0.2143rem_+_2.6786vw),1.5rem)] md:gap-[clamp(1.25rem,calc(1.875rem_-_0.7813vw),1.5rem)] xl:gap-[clamp(1.25rem,1.5625vw,1.5rem)] 2xl:gap-[clamp(1.5rem,1.5625vw,1.875rem)] 3xl:gap-[clamp(1.875rem,1.5625vw,2.5rem)]">
      <div className="relative w-[clamp(3.125rem,calc(0.8929rem_+_11.1607vw),6.25rem)] h-[clamp(3.125rem,calc(0.8929rem_+_11.1607vw),6.25rem)]  md:w-[clamp(3.75rem,calc(10rem_-_7.8125vw),6.25rem)] md:h-[clamp(3.75rem,calc(10rem_-_7.8125vw),6.25rem)] xl:w-[clamp(3.75rem,4.6875vw,4.5rem)] xl:h-[clamp(3.75rem,4.6875vw,4.5rem)] 2xl:w-[clamp(4.5rem,4.6875vw,5.625rem)] 2xl:h-[clamp(4.5rem,4.6875vw,5.625rem)] 3xl:w-[clamp(5.625rem,4.6875vw,7.5rem)] 3xl:h-[clamp(5.625rem,4.6875vw,7.5rem)]">
        <SanityImageView
          image={partner.image}
          fill
          sizes="12vw"
